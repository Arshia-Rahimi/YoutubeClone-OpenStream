package com.github.openstream.ui.global.reusable.screens.playlist
...
class PlaylistViewModel(
    ...
    val playlist =
        if (playlist !is PlaylistItem.LocalPlaylistItem) _playlist.asStateFlow() else playlistRepo.getPlaylistItem(
            playlist.id
        )
